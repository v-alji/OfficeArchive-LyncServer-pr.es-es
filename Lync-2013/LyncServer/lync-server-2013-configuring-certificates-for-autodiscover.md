...
12. Si es un servicio de detección automática, es decir, el lyncdiscover. \> nombre \> de dominio y lyncdiscoverinternal.\<domain name\> (según se trata de un certificado interno o externo) no se encuentra el nombre alternativo de asunto y está usando un único certificado predeterminado para los tipos predeterminados, WebServicesInternal y WebServiceExternal, haga lo siguiente:
