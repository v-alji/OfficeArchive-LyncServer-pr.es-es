...
## <a name="assigning-per-user-external-access-policies-by-using-windows-powershell-cmdlets"></a>Asignar Per-User directivas de acceso externo mediante cmdlets de Windows PowerShell
