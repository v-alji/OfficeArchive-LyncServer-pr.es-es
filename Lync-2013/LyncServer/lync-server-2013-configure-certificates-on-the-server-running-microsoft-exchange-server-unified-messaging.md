...
1.  En el servidor que ejecuta la mensajería unificada de Exchange, haga clic en **Inicio**, haga clic en **ejecutar**, escriba **http:// \<name of your Issuing CA Server\> /CertSrv** y, a continuación, haga clic en **Aceptar**.
...
1.  Inicie sesión en el servidor que ejecuta la mensajería unificada de Exchange con los derechos de usuario apropiados. Para obtener más información, vea "permisos de acceso de cliente" en [https://go.microsoft.com/fwlink/p/?linkId=195499](https://go.microsoft.com/fwlink/p/?linkid=195499) .
