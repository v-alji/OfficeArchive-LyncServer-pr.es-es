...
Los casos de prueba proporcionan una manera de probar las rutas de voz de su organización: usted define elementos como el número que se marcará y el plan de marcado y la Directiva de voz que se utilizará, y Lync Server 2013 puede comprobar que, dadas estas condiciones, el número proporcionado se pueda enrutar correctamente a la red PSTN.
