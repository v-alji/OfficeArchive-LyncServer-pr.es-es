...
Por ejemplo, si ha guardado los datos en un archivo denominado C: \\ lista de llamadas de grupo de respuesta de datos \\ \_ \_ \_ \_Report.csv, puede usar el siguiente comando para devolver el número total de llamadas recibidas para cada flujo de trabajo que aparece en el informe:
