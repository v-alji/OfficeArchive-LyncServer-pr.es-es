...
Esta sección le guiará a través de la configuración de los anuncios de Lync Server. Se da por hecho que ya ha leído las secciones de planificación relacionadas con los anuncios y ha implementado un servidor Enterprise Edition o un servidor Standard Edition con telefonía IP empresarial.
...
## <a name="in-this-section"></a>En esta sección
  ...
  - [Faculta Comprobar la implementación de la presentación en Lync Server 2013](lync-server-2013-optional-verify-announcement-deployment.md)
