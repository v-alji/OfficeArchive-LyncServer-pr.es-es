...
Estas opciones de configuración del archivado de Lync Server 2013 se describen más adelante en esta sección. Para obtener información sobre cómo configurar las directivas y la configuración de retención de Exchange In-Place para admitir el archivado, consulte la documentación del producto Exchange 2013.
