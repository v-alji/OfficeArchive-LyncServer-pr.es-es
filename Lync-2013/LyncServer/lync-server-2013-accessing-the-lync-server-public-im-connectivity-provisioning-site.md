...
El proceso de aprovisionamiento para la conectividad de Lync-Skype ha cambiado en comparación con los métodos de aprovisionamiento de PIC anteriores. Este proceso de aprovisionamiento puede demorar hasta 30 días en completarse. Recomendamos que inicie este proceso antes de continuar con el resto de los pasos que aparecen en este documento. Después de que se complete el proceso de aprovisionamiento de Lync-Skype para su cuenta, la cuenta se activa y los usuarios elegibles están habilitados para conectividad de mensajería instantánea pública.

### <a name="to-provision-lync-skype-connectivity-you-need-the-following-information"></a>Para aprovisionar Lync-Skype conectividad, necesita la siguiente información:
...
### <a name="to-initiate-the-provisioning-process-for-lync-skype-connectivity"></a>Para iniciar el proceso de aprovisionamiento de conectividad Lync-Skype:
