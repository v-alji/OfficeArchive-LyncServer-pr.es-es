...
<span data-ttu-id="a312e-107">Estas son las decisiones que debe considerar:</span><span class="sxs-lookup"><span data-stu-id="a312e-107">Here are the decisions that you must consider:</span></span>
