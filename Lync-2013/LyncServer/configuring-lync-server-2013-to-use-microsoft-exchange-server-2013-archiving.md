...
1.  No inicializados. Indica que el archivado se basará en la configuración de retención de In-Place configurada para el buzón de Exchange del usuario. Si In-Place Holding no se ha habilitado en el buzón del usuario, el usuario tendrá su mensajería y sus expedientes de conferencia web archivados en Lync Server.
...
4.  **ArchivingToExchange**. Indica que la mensajería instantánea del usuario y las transcripciones de conferencias web deberían archivarse en Exchange independientemente de la configuración de suspensión de In-Place que se haya asignado (o no) al buzón del usuario.
