...
<td><p>Contiene cambios en los servicios de dominio de Active Directory que aún no han procesado los pasos de sincronización de Active Directory más recientes y es una de las tablas temporales (junto con la tabla tblPrincipalMemberDifference) que se usa en el primer paso de la sincronización de Active Directory.</p>
