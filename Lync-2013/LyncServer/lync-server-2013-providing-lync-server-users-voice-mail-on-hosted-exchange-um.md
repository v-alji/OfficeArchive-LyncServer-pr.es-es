...
---
# <a name="providing-lync-server-2013-users-voice-mail-on-hosted-exchange-um"></a>Proporcionar correo de voz a usuarios de Lync Server 2013 en la mensajería unificada de Exchange hospedada
...
Esta sección le guiará a través del proceso de proporcionar a los usuarios en una implementación local de Lync Server 2013 con correo de voz en un servicio de mensajería unificada (UM) hospedada de Exchange.
