...
> [!NOTE]  
> La autenticación anónima se instala de forma predeterminada con la función de servidor IIS. Puede administrar la autenticación anónima después de la instalación de IIS. Para obtener más información, vea "habilitar la autenticación anónima (IIS 7)" en <A href="https://go.microsoft.com/fwlink/p/?linkid=203935">https://go.microsoft.com/fwlink/p/?linkId=203935</A> .
...
> [!NOTE]  
> Para Windows Server 2012 y Windows Server 2012 R2, el cmdlet Add-WindowsFeature ha sido reemplazado por el cmdlet Install-WindowsFeature. Para obtener información detallada, vea <A href="https://go.microsoft.com/fwlink/p/?linkid=392274">install-WindowsFeature</A>.
