...
Cada registro representa una sesión de punto a punto, que puede ser una llamada telefónica VoIP-VoIP, una sesión de mensajería instantánea de dos partes u otro tipo de sesión. Puede realizar una combinación de tabla con la [tabla multimedia en Lync Server 2013](lync-server-2013-media-table.md) para buscar los detalles de cada elemento multimedia implicado en esta sesión.
