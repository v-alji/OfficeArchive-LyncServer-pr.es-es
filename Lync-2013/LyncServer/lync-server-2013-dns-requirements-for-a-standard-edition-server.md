...
_**Tema Última modificación:** 2013-02-22_
...
[Requisitos DNS para el inicio de sesión automático del cliente en Lync Server 2013](lync-server-2013-dns-requirements-for-automatic-client-sign-in.md)  
