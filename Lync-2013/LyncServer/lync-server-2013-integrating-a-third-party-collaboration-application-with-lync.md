...
## <a name="integrating-an-internet-based-collaboration-application-with-lync-2013"></a>Integrar una aplicación de colaboración de Internet-Based con Lync 2013
...
En la siguiente tabla se describen las entradas del registro necesarias para integrar una aplicación de colaboración basada en Internet con Lync 2013. Estas entradas se colocan en el registro en la siguiente ubicación:
  ...
  - HKEY \_ local \_ Machine \\ Software \\ Microsoft \\ Office \\ 15,0 \\ Lync \\ SessionManager \\ , \\ parámetros de aplicaciones
...
En la tabla siguiente se describen las entradas del registro para parámetros. Estas entradas se colocan en el \_ software del usuario actual de \_ \\ \\ Microsoft \\ Office \\ 15,0 \\ Lync SessionManager de las \\ \\ aplicaciones \\ .
...
## <a name="integrating-a-server-based-collaboration-application-with-lync-2013"></a>Integrar una aplicación de colaboración de Server-Based con Lync 2013

La configuración para agregar comandos para iniciar una aplicación de colaboración basada en servidor desde Lync 2013 es similar a la que se describe en la sección anterior, integrando una aplicación de colaboración de Internet-Based con Lync 2013. Sin embargo, la OriginatorPath no es obligatoria y se modifican algunos valores. Las entradas del registro se colocan en la siguiente ubicación:
