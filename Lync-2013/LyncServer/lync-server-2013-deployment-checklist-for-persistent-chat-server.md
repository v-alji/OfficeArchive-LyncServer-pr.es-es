...
<p>Si instala el servidor de chat persistente en la edición estándar, el nombre de dominio completo (FQDN) del grupo de servidores de chat persistente debe coincidir con el servidor Standard Edition y las bases de datos de SQL Server se colocan en la instancia de SQL Server Express en el servidor Standard Edition</p></td>
