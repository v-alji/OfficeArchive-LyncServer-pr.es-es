...
<ol>
<li><p>Seleccione el botón <strong>Opciones</strong> y, a continuación, haga clic en <strong>File</strong> &gt; <strong>cerrar</strong>archivo.</p></li>
...
<td><p>En la ventana principal de Lync, seleccione el botón <strong>Opciones</strong> y, a continuación, seleccione <strong>File</strong> &gt; <strong>Cerrar sesión</strong>en archivo.</p></td>
</tr>
<tr class="odd">
<td><p>Salir</p></td>
...
2.  En Internet Explorer, busque la página de inscripción web de la entidad de certificación de la organización.
    ...
    Pida a su administrador de Lync Server la dirección Web de este recurso si aún no la tiene. La dirección URL tendrá un aspecto similar a este: https://MyCA.\ [elnombredesuempresa \] . com/certsrv.
