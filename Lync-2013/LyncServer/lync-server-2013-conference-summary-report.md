...
El informe Resumen de la Conferencia no solo le indica el número de conferencias que se han mantenido durante un período de tiempo determinado (cada hora, diariamente, semanalmente, mensualmente), pero también le indica el número total de personas que participaron en esas conferencias, así como el número total de organizadores de conferencia únicos.
