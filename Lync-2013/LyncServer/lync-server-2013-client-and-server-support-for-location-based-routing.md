...
El enrutamiento de Location-Based es exigido por Lync Server. Lync Server puede identificar los sitios de red desde los que se conectan los usuarios dentro de la red corporativa. Dado que los usuarios remotos están fuera de la red corporativa, su ubicación se considera como desconocida.

<div>

## <a name="lync-server-support"></a>Soporte técnico de Lync Server

Location-Based enrutamiento requiere que Lync Server 2013 CU1 se implemente en todos los grupos de servidores front-end y servidores Standard Edition en una topología determinada. Si Lync Server 2013 CU1 no está instalado en algunos componentes de Lync de la topología, no se pueden aplicar las restricciones de enrutamiento de Location-Based.

En la siguiente tabla se identifica la combinación de las versiones y los roles de servidor que se admiten para Location-Based el enrutamiento.
...
La siguiente tabla identifica los clientes que admite el enrutamiento de Location-Based.
...
<td><p>no</p></td>
<td><p>VoIP debe estar deshabilitado para los clientes de Lync Mobile 2013 si lo usan los usuarios con el enrutamiento Location-Based habilitado.</p></td>
</tr>
<tr class="even">
