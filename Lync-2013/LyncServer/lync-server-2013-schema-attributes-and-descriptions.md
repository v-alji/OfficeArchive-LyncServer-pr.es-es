...
<td><p>Este atributo es un valor de cadena de valor único. El valor de este atributo, cuando está presente, representa el FQDN de dominio de la agrupación si el administrador desea crear un grupo front-end con un FQDN que no se ajuste a la estructura de dominios de Active Directory en la que se crea el grupo front-end (por ejemplo, un espacio de nombres SIP separado del espacio de nombres del sistema de nombres de dominio (DNS)).</p>
