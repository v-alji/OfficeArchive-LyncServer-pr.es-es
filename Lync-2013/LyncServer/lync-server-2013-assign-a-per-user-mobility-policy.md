...
## <a name="assigning-a-per-user-mobility-policy-by-using-windows-powershell-cmdlets"></a>Asignar una directiva de movilidad de Per-User con cmdlets de Windows PowerShell
...
## <a name="to-assign-a-per-user-mobility-policy-to-multiple-users"></a>Para asignar una directiva de movilidad por usuario a varios usuarios
  ...
  - El comando siguiente asigna la Directiva de movilidad por usuario RedmondMobilityPolicy a todos los usuarios que actualmente tienen asignada la Directiva NorthAmericaMobilityPolicy. Para obtener más información sobre el parámetro de filtro usado en este comando, vea [Get-CsUser](https://technet.microsoft.com/library/gg398125\(v=ocs.15\)).
