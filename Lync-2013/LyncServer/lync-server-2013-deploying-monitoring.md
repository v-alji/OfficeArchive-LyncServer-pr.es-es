...
> [!NOTE]  
> Si se ha habilitado la supervisión para un grupo, puede deshabilitar el proceso de recopilación de datos de supervisión sin tener que cambiar su topología: el shell de administración de Lync Server proporciona una forma de deshabilitar (y volver a habilitar más adelante) la recopilación de datos de grabación de detalles de llamadas (CDR) o calidad de la experiencia (QoE). Para obtener más información, vea la sección de configuración del registro de detalles de llamadas y los valores de calidad de experiencia de este documento.
