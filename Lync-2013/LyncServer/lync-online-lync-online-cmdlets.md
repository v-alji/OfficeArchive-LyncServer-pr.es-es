...
Para obtener más información sobre cómo configurar el equipo para usar Windows PowerShell para administrarlo con Lync Online, vea el tema de ayuda [usar Windows PowerShell para administrar Lync Online](https://technet.microsoft.com/library/Dn362831(v=OCS.15)).
