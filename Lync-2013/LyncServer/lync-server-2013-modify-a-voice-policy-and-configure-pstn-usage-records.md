...
6.  Active o desactive las casillas siguientes para habilitar o deshabilitar cada una de las **Características de llamadas**:
      ...
      - La **anulación** de la Directiva de ancho de banda permite a los administradores anular las decisiones de directiva de control de admisión de llamadas (CAC) para un usuario en particular. Está deshabilitada de forma predeterminada.
