...
1.  Cuando la plantilla requerida esté disponible para la CA, use el siguiente cmdlet de Windows PowerShell en el servidor perimetral para solicitar el certificado:
    ...
    El nombre de certificado predeterminado de la plantilla proporcionada en Lync Server 2013 es servidor Web. Especifique solo el \<template name\> si necesita usar una plantilla diferente de la predeterminada.
