...
4.  \_sipinternal. \_ TCP.\<domain\>   Registro SRV (localizador de servicios) para conexiones TCP internas (solo si se permite TCP)

5.  \_SIP. \_ TSL.\<domain\>   Registro SRV (localizador de servicios) para conexiones TLS externas

6.  sipinternal.\<domain\>   Un registro (host) para el director o grupo de servidores front-end, que solo se pueda resolver en la red interna

7.  sip.\<domain\>   Un registro (host) para el grupo de servidores front-end o el director de la red interna, o el servicio perimetral de acceso cuando el cliente es externo

8.  sipexternal.\<domain\>   Un registro (host) para el servicio perimetral de acceso cuando el cliente es externo
...
## <a name="configuring-split-brain-dns-with-lync-server"></a>Configuración del Split-Brain DNS con Lync Server
...
Para obtener más información, consulte el artículo del blog de DMTF, "Communicator Automatic Configuration and Split-Brain DNS", en [https://go.microsoft.com/fwlink/p/?linkId=200707](https://go.microsoft.com/fwlink/p/?linkid=200707) .
