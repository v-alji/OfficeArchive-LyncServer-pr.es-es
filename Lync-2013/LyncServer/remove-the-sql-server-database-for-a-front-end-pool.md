...
4.  Para quitar la base de datos para el almacén de aplicaciones del grupo, escriba:
    ...
    Donde \<FQDN\> es el nombre completo del servidor de la base de datos y \<instance\> es la instancia de la base de datos con nombre (es decir, si se definió una).
