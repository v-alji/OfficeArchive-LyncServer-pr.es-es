...
3.  En el editor del registro, expanda **equipo**, expanda **HKEY \_ local \_ Machine**, expanda **software**, expanda **directivas**, expanda **Microsoft**, expanda **Windows** y, a continuación, haga clic en **QoS**. En **QoS** , debe ver las claves del registro para cada una de las directivas de QoS que acaba de crear. Por ejemplo, si ha creado dos nuevas directivas (una con el nombre QoS de audio de Lync Server y la otra llamada de vídeo de Lync Server QoS), debe entradas del registro para QoS de audio de Lync Server y la calidad de video de Lync Server.
