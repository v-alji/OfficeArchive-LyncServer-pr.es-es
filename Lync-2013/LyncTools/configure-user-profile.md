...
4.  En **Índice de inicio de usuario**, haga clic o escriba el índice del primer usuario que desee configurar. Puede configurar rangos diferentes para distintos tipos o niveles de carga, pero debe ejecutar UserProfileGenerator.exe una vez por el intervalo que desee configurar.
